  ...
  return (
    <section id="contact" className="kw24-contact sec" ref={sectionRef}>
      ...
      <style jsx global>{`
        ...
        .kw24-contact .badge i { width: 6px; height: 6px; background: var(--gold); border-radius: 50%; animation: contactBlink 1.4s infinite; }
        ...
        .kw24-contact h2 .g { color: var(--gold); }
        ...
        .kw24-contact .links a:hover { color: var(--gold); }
