...
export default function Contact() {
  ...
  return (
    <section id="contact" className="kw24-contact sec" ref={sectionRef}>
      ...
      <style jsx global>{`
        .kw24-contact.sec { position: relative; padding: 120px 56px; overflow: hidden; --card: #ffffff; --card-b: #e4dcc8; }
        ...
        .kw24-contact .glow { position: absolute; width: 700px; height: 400px; left: 50%; top: 50%; transform: translate(-50%,-50%); background: radial-gradient(ellipse, rgba(184,145,43,.06) 0%, transparent 70%); z-index: 0; pointer-events: none; }

        .kw24-contact .wrap { position: relative; z-index: 2; max-width: 520px; margin: 0 auto; text-align: center; }
        .kw24-contact .badge { display: inline-flex; align-items: center; gap: 8px; border: 1px solid #e4dcc8; padding: 6px 14px; border-radius: 100px; font-size: 11px; color: rgba(26,23,18,.45); letter-spacing: .5px; margin-bottom: 22px; opacity: 0; transform: translateY(16px); transition: all .6s var(--ease); }
        ...
        .kw24-contact h2 .g { color: var(--accent); }
        .kw24-contact .subtext { font-size: 15px; font-weight: 300; color: rgba(26,23,18,.45); line-height: 1.7; margin-bottom: 44px; opacity: 0; transform: translateY(20px); transition: all .7s var(--ease) .16s; }
        ...
        .kw24-contact input::placeholder, .kw24-contact textarea::placeholder { color: rgba(26,23,18,.25); }
        .kw24-contact input:focus, .kw24-contact textarea:focus { border-color: rgba(184,145,43,.55); box-shadow: 0 0 0 3px rgba(184,145,43,.08); }
        ...
        .kw24-contact .submit:hover { box-shadow: 0 0 40px rgba(184,145,43,.4); }
        ...
        .kw24-contact .links a { display: flex; align-items: center; gap: 7px; font-size: 13px; color: rgba(26,23,18,.45); text-decoration: none; transition: color .2s; }
