...
export default function MetaAds() {
  ...
  return (
    <section id="performance-marketing" className="kw24-meta-ads sec">
      ...
      <style jsx global>{`
        .kw24-meta-ads.sec { min-height: 100vh; min-height: 100svh; display: flex; align-items: center; justify-content: center; padding: 90px 56px; position: relative; overflow: hidden; --accent-d: #8a6a1e; --meta-blue: #1877f2; --green: #42b72a; }
