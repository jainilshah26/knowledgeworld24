...
const ADS: AdDatum[] = [
  ...
  },
  {
    ...
    grad: 'linear-gradient(135deg,#2a1608 0%,#6b3d1c 55%,#c9a66b 100%)',
...
export default function MetaAds() {
  ...
  return (
    <section id="performance-marketing" className="kw24-meta-ads sec">
      ...
      <style jsx global>{`
        .kw24-meta-ads.sec { min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 90px 56px; position: relative; overflow: hidden; --gold-d: #8c6f3e; --meta-blue: #1877f2; --green: #42b72a; }
        ...
        .kw24-meta-ads .points .tick { width: 20px; height: 20px; border-radius: 50%; background: rgba(201,166,107,.12); border: 1px solid var(--gold); color: var(--gold); display: flex; align-items: center; justify-content: center; font-size: 11px; flex-shrink: 0; }
        ...
        .kw24-meta-ads .screen { background: #f0f2f5; border-radius: 12px; overflow: hidden; box-shadow: 0 40px 120px rgba(201,166,107,.12), 0 20px 60px rgba(0,0,0,.6); }
        ...
        .kw24-meta-ads .adcard .ad-img { height: 96px; position: relative; display: flex; align-items: flex-end; overflow: hidden; padding: 10px 12px; border-top: 1px solid rgba(201,166,107,.18); }
        ...
        .kw24-meta-ads .roasbadge { position: absolute; top: -54px; right: 24px; z-index: 6; background: #070d0a; border: 1px solid var(--gold); border-radius: 100px; padding: 8px 18px; display: flex; align-items: center; gap: 10px; box-shadow: 0 0 30px rgba(201,166,107,.3); }
