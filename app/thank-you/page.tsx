    ...
    <section className="kw24-thank-you sec">
      ...
      <div className="card">
        ...
        <div className="actions">
          ...
          <a href="/blog" className="bs">Read Our Blog</a>
        </div>
      </div>
      ...
      <style jsx global>{`
        ...
        .kw24-thank-you .badge { display: inline-flex; align-items: center; gap: 8px; border: 1px solid #222; padding: 6px 14px; border-radius: 100px; font-family: var(--mono); font-size: 11px; color: rgba(255,255,255,.45); letter-spacing: .5px; margin-bottom: 20px; opacity: 0; animation: tyFade .7s ease .7s forwards; }
